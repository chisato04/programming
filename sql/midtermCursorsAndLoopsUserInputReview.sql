...
FOR rec IN YLname_emp LOOP
IF rec.salary < 30000 THEN
UPDATE employees SET salary = salary * 1.05 WHERE CURRENT OF YLname_emp ;
ELSE
UPDATE employees SET salary = salary * 1.02 WHERE CURRENT OF YLname_emp ;
END IF;
